<script>
  ...
  <ul class="pill-list is-horizontal">
    <li class="pill-item">
        <span class="pill-var">0</span>
        <span class="pill-label">Unassigned Players</span>
    </li>
    <li class="pill-item">
        <span class="pill-var">0</span>
        <span class="pill-label"><a href="#teams">Teams</a></span>
    </li>
    <li class="pill-item">
        <span class="pill-var">0</span>
        <span class="pill-label"><a href="#inactive-players">Inactive Players</a></span>
    </li>
</ul>
...
<div class="team-status-box well">
    ...
    <ul class="pill-list is-large">
        <li class="pill-item">
            <span class="pill-var">0</span>
            <span class="pill-label"><a href="#team_a">Team A</a></span>
        </li>
        <li class="pill-item">
            <span class="pill-var">0</span>
            <span class="pill-label"><a href="#team_a">Team B</a></span>
        </li>
    </ul>
    ...
    <!-- todo: show this if teams -->

    <h3 class="card-heading text-center">Create your first team </h3>
    <p class="text-center">Teams may be created manually now. Alternatively once players arrive, you may randomly distribute players into teams.</p>
