      ...
      <ul class="dropdown-list">
        {#each teams as team}
          <li class="dropdown-item">
            <a
              ...
              >{team.name}
              {#if team.session}<small>{formatSession(team.session)}</small>{/if}
            </a>
          </li>
        {/each}
        <li class="dropdown-item">
        ...
        <li class="dropdown-item">
          <a
            ...
            <svg class="icon theme-alert-color" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4.91 9.541h3.272c1.164 0 2.283.48 3.111 1.337a4.68 4.68 0 0 1 1.298 3.25v1.13c0 .023-.01.042-.02.052a.037.037 0 0 1-.025.012h-12a.037.037 0 0 1-.027-.012.076.076 0 0 1-.019-.053v-1.13a4.68 4.68 0 0 1 1.298-3.249 4.324 4.324 0 0 1 3.111-1.337ZM3.226 3.956c0-.922.354-1.804.978-2.45A3.253 3.253 0 0 1 6.545.5c.875 0 1.717.36 2.34 1.006a3.53 3.53 0 0 1 .979 2.45 3.53 3.53 0 0 1-.978 2.45 3.253 3.253 0 0 1-2.34 1.005c-.875 0-1.717-.36-2.34-1.005a3.53 3.53 0 0 1-.979-2.45Z" stroke="currentColor"/></svg>
            Mark inactive</a
          >
        </li>
        {/if}
        {#if assigned}
          <li class="dropdown-item">
            <a
              ...
              <svg class="icon theme-info-color" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4.91 9.541h3.272c1.164 0 2.283.48 3.111 1.337a4.68 4.68 0 0 1 1.298 3.25v1.13c0 .023-.01.042-.02.052a.037.037 0 0 1-.025.012h-12a.037.037 0 0 1-.027-.012.076.076 0 0 1-.019-.053v-1.13a4.68 4.68 0 0 1 1.298-3.249 4.324 4.324 0 0 1 3.111-1.337ZM3.226 3.956c0-.922.354-1.804.978-2.45A3.253 3.253 0 0 1 6.545.5c.875 0 1.717.36 2.34 1.006a3.53 3.53 0 0 1 .979 2.45 3.53 3.53 0 0 1-.978 2.45 3.253 3.253 0 0 1-2.34 1.005c-.875 0-1.717-.36-2.34-1.005a3.53 3.53 0 0 1-.979-2.45Z" fill="currentColor"/></svg>
                Unassign</a
            >
          </li>
        {/if}
